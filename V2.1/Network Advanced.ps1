...
$menu = @(
    ...
    "║ 2. Configure IP Address (Static/DHCP)            ║",
    "║ 3. View Network Adapters                         ║",
    ...
    switch ($choice) {
        "1" {
            ...
            try {
                ...
                Write-Host " Error configuring static IPv4 address: `n$_" -ForegroundColor Red
            }
        ...
        "2" {
            ...
            Write-Host "`nConfigure Static IPv6 Address:" -ForegroundColor Green
            Write-Host "---------------------------" -ForegroundColor Green
            ...
            try {
                ...
                Write-Host "Static IPv6 address configured successfully." -ForegroundColor Green
            } catch {
                Write-Host "Error configuring static IPv6 address: $_" -ForegroundColor Red
            }
        ...
        "3" {
            # Configure DHCP
            Write-Host "`nConfiguring DHCP:" -ForegroundColor Green
            Write-Host "---------------" -ForegroundColor Green
            ...
            try {
                ...
                # Handle DNS settings
                $dnsConfig = Read-Host "Do you want to use DHCP for DNS server assignment too? (Y/N)"
                if ($dnsConfig -eq "Y" -or $dnsConfig -eq "y") {
                    Set-DnsClientServerAddress -InterfaceIndex $interface.ifIndex -ResetServerAddresses
                    Write-Host "DNS servers will be obtained automatically." -ForegroundColor Green
                }
                ...
                Write-Host "Waiting for DHCP to assign an address..." -ForegroundColor Cyan
        ...
        "4" {
            ...
            Write-Host "`nAdd Additional IP Address:" -ForegroundColor Green
            Write-Host "-----------------------" -ForegroundColor Green
        ...
        "5" {
            ...
            Write-Host "`nConfigure DNS Servers:" -ForegroundColor Green
            Write-Host "--------------------" -ForegroundColor Green
            
            $manualDns = Read-Host "Enter primary DNS server (e.g., 8.8.8.8)"
            $secondaryDns = Read-Host "Enter secondary DNS server (optional)"
        ...
        "6" {
            ...
            Write-Host "`nCurrent IP Configuration:" -ForegroundColor Green
            Write-Host "-----------------------" -ForegroundColor Green
            ...
            if ($ipv4) {
                Write-Host "`nIPv4 Configuration:" -ForegroundColor Green
                foreach ($ip in $ipv4) {
                ...
                Write-Host "`nNo IPv4 configuration found." -ForegroundColor Yellow
            }
            
            # IPv6 Configuration
            $ipv6 = $ipConfig.IPv6Address
            if ($ipv6) {
                Write-Host "`nIPv6 Configuration:" -ForegroundColor Green
                foreach ($ip in $ipv6) {
                    Write-Host "  IP Address: $($ip.IPAddress)" -ForegroundColor Cyan
                    Write-Host "  Prefix Length: $($ip.PrefixLength)" -ForegroundColor Cyan
                }
                ...
                Write-Host "`nNo IPv6 configuration found." -ForegroundColor Yellow
            }
            ...
            try {
                ...
                Write-Host "`nDHCP Status:" -ForegroundColor Green
...
function Run-NetworkDiagnostics {
    if (-not $global:selectedInterface) {
        Write-Host "No interface selected. Please select an interface first." -ForegroundColor Red
        Start-Sleep -Seconds 2
        Select-NetworkInterface
        return
    }
    ...
    switch ($choice) {
        "1" {
            # Ping Test
            Write-Host "`nPing Test:" -ForegroundColor Green
            Write-Host "---------" -ForegroundColor Green
        ...
        "2" {
            # Trace Route
            Write-Host "`nTrace Route:" -ForegroundColor Green
            Write-Host "-----------" -ForegroundColor Green
            ...
            try {
                Test-NetConnection -TraceRoute $target -ErrorAction Stop | ForEach-Object {
                    Write-Host "Hop $($_.Hop): $($_.Address) - $($_.ResponseTime)ms" -ForegroundColor Cyan
                }
            } catch {
        ...
        "3" {
            # DNS Lookup
            Write-Host "`nDNS Lookup:" -ForegroundColor Green
            Write-Host "----------" -ForegroundColor Green
            ...
            try {
                ...
                foreach ($record in $dnsResult) {
                    Write-Host "Name: $($record.Name), Type: $($record.Type), Address: $($record.IPAddress)" -ForegroundColor Cyan
                }
            } catch {
        ...
        "4" {
            ...
            Write-Host "`nNetwork Speed Test:" -ForegroundColor Green
            Write-Host "-----------------" -ForegroundColor Green
            
            Write-Host "This feature requires an external tool like iPerf or Speedtest CLI." -ForegroundColor Yellow
            Write-Host "Please install the required tool and configure it to use this script." -ForegroundColor Yellow
        ...
        "5" {
            ...
            Write-Host "`nNetwork Connectivity Check:" -ForegroundColor Green
            Write-Host "-------------------------" -ForegroundColor Green
        ...
        "6" {
            ...
            Write-Host "`nPort Connectivity Test:" -ForegroundColor Green
            Write-Host "---------------------" -ForegroundColor Green
            ...
            try {
                ...
                if ($portTest.TcpTestSucceeded) {
                    ...
                    Write-Host "Port $port is closed or unreachable on $target." -ForegroundColor Red
                }
            } catch {
        ...
        "7" {
            ...
            Write-Host "`nConnection Statistics:" -ForegroundColor Green
            Write-Host "---------------------" -ForegroundColor Green
            ...
            try {
                ...
                Write-Host "Could not retrieve connection statistics: $_" -ForegroundColor Red
            }
...
function Manage-NetworkProfiles {
    ...
    switch ($choice) {
        "1" {
            ...
            Write-Host "`nSave Current Configuration:" -ForegroundColor Green
            Write-Host "-------------------------" -ForegroundColor Green
        ...
        "2" {
            # Load Saved Profile
            Write-Host "`nLoad Saved Profile:" -ForegroundColor Green
            Write-Host "-----------------" -ForegroundColor Green
        ...
        "3" {
            ...
            Write-Host "`nDelete Saved Profile:" -ForegroundColor Green
            Write-Host "-------------------" -ForegroundColor Green
...
function Manage-WiFi {
    ...
    switch ($choice) {
        ...
        "2" {
            ...
            Write-Host "`nConnect to Wi-Fi Network:" -ForegroundColor Green
            Write-Host "-----------------------" -ForegroundColor Green
...
"@
        ...
        "3" {
            ...
            Write-Host "`nDisconnect from Wi-Fi:" -ForegroundColor Green
            Write-Host "---------------------" -ForegroundColor Green
        ...
        "4" {
            ...
            Write-Host "`nManage Saved Wi-Fi Networks:" -ForegroundColor Green
            Write-Host "--------------------------" -ForegroundColor Green
        ...
        "5" {
            ...
            Write-Host "`nView Wi-Fi Signal Strength:" -ForegroundColor Green
            Write-Host "-------------------------" -ForegroundColor Green
        ...
        "6" {
            ...
            Write-Host "`nCreate Wi-Fi Hotspot:" -ForegroundColor Green
            Write-Host "--------------------" -ForegroundColor Green
...
function Manage-Firewall {
    ...
    switch ($choice) {
        ...
        "2" {
            ...
            Write-Host "`nEnable/Disable Firewall:" -ForegroundColor Green
            Write-Host "---------------------" -ForegroundColor Green
            
            $action = Read-Host "Enter 'enable' or 'disable'"
            $profile = Read-Host "Enter profile (Domain, Private, Public)"
            ...
            try {
                ...
                Write-Host "Error modifying firewall: $_" -ForegroundColor Red
            }
        ...
        "3" {
            # Add Firewall Rule
            Write-Host "`nAdd Firewall Rule:" -ForegroundColor Green
            Write-Host "----------------" -ForegroundColor Green
        ...
        "4" {
            ...
            Write-Host "`nRemove Firewall Rule:" -ForegroundColor Green
            Write-Host "-------------------" -ForegroundColor Green
...
function Monitor-Network {
    ...
    switch ($choice) {
        "1" {
            ...
            Write-Host "`nMonitor Network Traffic:" -ForegroundColor Green
            Write-Host "----------------------" -ForegroundColor Green
        ...
        "3" {
            ...
            Write-Host "`nBandwidth Usage:" -ForegroundColor Green
            Write-Host "---------------" -ForegroundColor Green
        ...
        "4" {
            ...
            Write-Host "`nNetwork Performance Statistics:" -ForegroundColor Green
            Write-Host "------------------------------" -ForegroundColor Green
        ...
        "5" {
            ...
            Write-Host "`nContinuous Network Monitoring:" -ForegroundColor Green
            Write-Host "------------------------------" -ForegroundColor Green
...
while ($true) {
    ...
    switch ($choice) {
        "1" { Get-InterfaceInfo }
        "2" { Configure-IPAddress }
        "3" { Select-NetworkInterface }
